...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://ai-talk-battle.onrender.com',
    siteName: 'AI Talk Battle',
    type: 'website',
    locale: 'en_US',
    alternateLocale: 'ja_JP',
    images: [{ url: 'https://ai-talk-battle.onrender.com/api/og', width: 1200, height: 630, alt: 'AI Talk Battle' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'AI Talk Battle ⚔️',
    description: 'Pick two AI characters. Give them a topic. Watch them battle it out.',
    images: ['https://ai-talk-battle.onrender.com/api/og'],
